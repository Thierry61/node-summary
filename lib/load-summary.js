...
// Function to keep 4 digits of precision (used for number of days and difficulty adjustments)
function precision4(n) {
    const magnitude = Math.pow(10, Math.floor(Math.log10(n))+1)
    const res = Math.floor(n/magnitude*10000)/10000*magnitude
    // Get rid of residual digits like 6.470000000000001
    const truncate = 1e10
    return Math.floor(res*truncate)/truncate
}
